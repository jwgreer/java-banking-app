...
public class MainMenu extends javax.swing.JFrame {
    ...
    private void showAccountsButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_showAccountsButtonActionPerformed
        ...
        if (customers == null || customers.isEmpty()) {
            JOptionPane.showMessageDialog(this, "Select a customer or add a new customer to show accounts!", "Input Error", JOptionPane.ERROR_MESSAGE);
            return;
        }
        ...
        if (selectedRow == -1) {
            JOptionPane.showMessageDialog(this, "Select a customer to show accounts!", "Input Error", JOptionPane.ERROR_MESSAGE);
            return;
        }
        ...
        // Create a new ShowAccountsFrame and pass the selected customer's bank accounts
        ShowAccountsFrame showAccountsFrame = new ShowAccountsFrame(selectedCustomer, customers);
